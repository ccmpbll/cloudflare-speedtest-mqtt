...
Uses cfspeedtestclass.py to generate statistics for current ISP which
approximate those generated by Cloudflares's browser interface.
...
def main():
    ...
    speedtest=cfspeedtestclass.cloudflare() #open first with no args to get version
